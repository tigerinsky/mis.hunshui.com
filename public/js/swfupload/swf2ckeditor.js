function flashupload(uploadid, name, textareaid, funcName,uploadurl, args, module, catid, authkey,by) {
	var args = args ? '&args='+args : '';
	var setting = '&module='+module+'&catid='+catid+'&authkey='+authkey;
	window.top.art.dialog({title:name,id:uploadid,iframe:uploadurl+'/?by='+by+args+setting,width:'500',height:'420'}, function(){
			 if(funcName){
