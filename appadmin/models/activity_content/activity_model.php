...
class Activity_model extends CI_Model {
    ...
    public function get_data_by_parm($where,$limit){
        $query_data = "SELECT `id`, `title`, `author`, `brief`, `content` FROM ci_mis_activity_tpl {$where} ORDER BY id DESC {$limit}";
    ...
    public function get_count_by_parm($where){
        $query_data = "SELECT count(id) as nums FROM ci_mis_activity_tpl {$where}";
        $result_data = $this->dbr->query($query_data);
    ...
    public function get_info_by_id($id){
        $query_data = "SELECT `id`, `title`, `author`, `brief`, `content` FROM ci_mis_activity_tpl WHERE id=?";
    ...
    public function del_info($ids){
        ...
        $del_rule="delete from ci_mis_activity_tpl WHERE id IN('{$id_str}')";
    ...
    public function create_info($info){
        $insert_query=$this->db->insert_string('ci_mis_activity_tpl', $info);
    ...
    public function update_info($info,$id){
        $where="id={$id}";
        $update_rule=$this->db->update_string('ci_mis_activity_tpl', $info, $where);
